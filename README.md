...
Application of SQL skills to analyze historical credit card transactions and consumption patterns in order to identify possible fraudulent transactions.
...
3. [Data Engineering](#Data-Engineering): Create a database schema on PostgreSQL and populate your database from the CSV files provided.
4. [Data Analysis](#Data-Analysis): Analyze the data to identify possible fraudulent transactions.
...
![QuickDBD-export](Results/QuickDBD-export.png)
...
![Early_hour](Results/Early_hour.PNG)
...
* Fraudulent transactions in the history of two of the most important customers of the firm on the basis of their cardholders' IDs are 18 and 2.
 ...
 ![id_holder_2](Results/id_holder_2.PNG)
 ![id_holder_18](Results/id_holder_18.PNG)
...
* The CEO of the firm's biggest customer suspects that someone has used her corporate credit card without authorization in the first quarter of 2018 to pay for several expensive restaurant bills. You are asked to find any anomalous transactions during that period.
  ...
  * Using Plotly Express, created a series of six box plots, one for each month, in order to identify how many outliers there are per month for cardholder ID 25.
  ...
  ![id_holder_25](Results/id_holder_25.PNG)
...
![anomalous_transaction](Results/anomalous_transaction.PNG)
